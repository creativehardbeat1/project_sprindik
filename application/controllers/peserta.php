...
class Peserta extends CI_Controller {
	...
	public function ajax_edit($id_peserta)
	{
		$data = $this->peserta->get_by_id($id_peserta);
	...
	public function ajax_update()
	{
		...
		$this->peserta->update(array('id_peserta' => $this->input->post('id_peserta')), $data);
		echo json_encode(array("status" => TRUE));
	}

	public function ajax_delete($id_peserta)
	{
		$this->peserta->delete_by_id($id_peserta);
		echo json_encode(array("status" => TRUE));
	}
