...
class User_diklat_model extends CI_Model {
	...
	function get_datatables_persetujuan_a()
	{
		$this->_get_datatables_persetujuan_a_query();
		if($_POST['length'] != -1)
		$this->db->limit($_POST['length'], $_POST['start']);
		$query = $this->db->get();
		return $query->result();
	}
	//--end persetujuan dokumen--
	...
	function get_datatables_persetujuan_b()
	{
		$this->_get_datatables_persetujuan_b_query();
		if($_POST['length'] != -1)
		$this->db->limit($_POST['length'], $_POST['start']);
		$query = $this->db->get();
		return $query->result();
